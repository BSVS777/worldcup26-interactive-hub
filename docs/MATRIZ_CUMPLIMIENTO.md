...
|---|---|---|---|---|---|
| SPEC-ACC-001 | Accesibilidad e inclusion son objetivo transversal obligatorio | `docs/ACCESIBILIDAD_SEGURIDAD_SPEC.md`, `tools/zoom-reflow-audit.py` | Spec define ACC-001..ACC-012 y Definition of Done; Matrix movil verificada; reflow 200%/400% verificado en cinco rutas (`ZOOM_REFLOW_AUDIT_PASS`) | IMPLEMENTADO | Pendiente auditoria manual con lector y contraste completo. |
