...
| QA-003 | Navegación por teclado verificada | Links/botones nativos; trap de Tab en modal 401; Tour mueve foco al heading del detalle seleccionado | `test/static-contract.test.mjs`, `test/tour.test.mjs`; pendiente prueba manual completa | EN PROGRESO | Falta evidencia manual de teclado completo. |
