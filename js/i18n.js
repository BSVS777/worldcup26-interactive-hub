...
const COPY = Object.freeze({
  es: Object.freeze({
    ...
    'session.modeGroupLabel': 'Elige cómo acceder',
    'session.modeLogin': 'Iniciar sesión',
    'session.modeRegister': 'Crear una cuenta de prueba',
    'session.modePublic': 'Continuar en modo público',
    'session.publicModeStatus': 'Modo público · Datos consultados sin sesión JWT',
    'session.jwtActiveStatus': 'Sesión JWT activa',
    'session.logout': 'Cerrar sesión',
    'session.loggedOut': 'Sesión cerrada. Volviste al modo público.',
    'register.name': 'Nombre',
    'register.confirmPassword': 'Confirmación de contraseña',
    'register.submit': 'Crear cuenta',
    'register.submitPending': 'Creando cuenta…',
    'register.successCreating': 'Cuenta creada. Iniciando sesión…',
    'register.autoLoginFailed': 'La cuenta fue creada, pero no fue posible iniciar sesión automáticamente. Intenta ingresar manualmente.',
    'register.genericFailure': 'No pudimos crear la cuenta. Inténtalo de nuevo.',
    'register.duplicateOrRejected': 'El registro fue rechazado: es posible que el correo ya esté registrado o que los datos no sean válidos.',
    'register.rejected': 'El registro fue rechazado por el servidor. Revisa los datos ingresados e inténtalo de nuevo.',
    'register.unreachable': 'No se pudo contactar el servicio de registro. Revisa tu conexión e inténtalo de nuevo.',
    'register.busy': 'El servicio de registro está ocupado. Espera un momento e inténtalo de nuevo.',
    'register.unavailable': 'El servicio de registro no está disponible temporalmente. Inténtalo de nuevo en unos instantes.',
    'register.nameRequired': 'Ingresa tu nombre.',
    'register.emailInvalid': 'Ingresa un correo electrónico válido.',
    'register.passwordRequired': 'Ingresa una contraseña.',
  ...
  en: Object.freeze({
    ...
    'session.modeGroupLabel': 'Choose how to access',
    'session.modeLogin': 'Sign in',
    'session.modeRegister': 'Create a test account',
    'session.modePublic': 'Continue in public mode',
    'session.publicModeStatus': 'Public mode · Data fetched without a JWT session',
    'session.jwtActiveStatus': 'JWT session active',
    'session.logout': 'Sign out',
    'session.loggedOut': 'Signed out. You are back in public mode.',
    'register.name': 'Name',
    'register.confirmPassword': 'Confirm password',
    'register.submit': 'Create account',
    'register.submitPending': 'Creating account…',
    'register.successCreating': 'Account created. Signing in…',
    'register.autoLoginFailed': 'The account was created, but automatic sign-in failed. Try signing in manually.',
    'register.genericFailure': 'We could not create the account. Try again.',
    'register.duplicateOrRejected': 'Registration was rejected: this email may already be registered or the data was rejected.',
    'register.rejected': 'Registration was rejected by the server. Check your details and try again.',
    'register.unreachable': 'Could not reach the registration service. Check your connection and try again.',
    'register.busy': 'The registration service is busy. Wait a moment and try again.',
    'register.unavailable': 'The registration service is temporarily unavailable. Try again shortly.',
